...
var actions = {
    ...
    resetConfig: function resetConfig() {
        return function (state) {
            ...
            var selected = keys.reduce(function (acc, k) {
                var newObject = _defineProperty({}, k, null);
    ...
    generateConfig: function generateConfig() {
        return function (state) {
            ...
            var keys = Object.keys(state.selected);
            var result = keys.reduce(function (acc, k) {
                var selectedKey = selected[k];
                var optionKey = _options2.default.find(function (o) {
                    return o.key === k;
                });
                var validate = optionKey.validate;
                var value = selectedKey !== null && validate === 'integer' ? parseInt(selectedKey) : selectedKey;
                var newObject = _defineProperty({}, k, value);
                return value !== null ? Object.assign({}, acc, newObject) : acc;
            }, {});
            var generatedConfig = JSON.stringify(result);
            return {
                showConfig: true,
...
var Config = function Config(_ref5) {
    ...
    return (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
            ...
            (0, _hyperapp.h)(
                'textarea',
                { name: 'textarea', autofocus: true, rows: '10', cols: '50' },
                generatedConfig
            ),
            (0, _hyperapp.h)(
                'div',
            ...
            (0, _hyperapp.h)(
                ...
                (0, _hyperapp.h)(
                    'button',
                    { 'class': 'green', onclick: resetConfig },
...
var view = function view(state, actions) {
    return (0, _hyperapp.h)(
        'div',
        null,
        state.showConfig && (0, _hyperapp.h)(Config, { generatedConfig: state.generatedConfig, resetConfig: actions.resetConfig }),
        (0, _hyperapp.h)(
            'h1',
            null,
        ...
        (0, _hyperapp.h)(
            ...
            (0, _hyperapp.h)(
                'button',
                { 'class': 'box green', onclick: actions.generateConfig },
                'Generate Config'
            )
        )
    );
...
},{"hyperapp":9,"./options":7}],19:[function(require,module,exports) {
...
//# sourceMappingURL=/prettier-config.fde9733a.map