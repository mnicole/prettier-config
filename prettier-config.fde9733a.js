        ...
        13: [
            function(require, module, exports) {
                ...
                function app(state, actions, view, container) {
                    ...
                    var oldNode =
                        rootElement && recycleElement(rootElement);
                    var lifecycle = [];
                    var skipRender;
                    ...
                    function eventListener(event) {
                        return event.currentTarget.events[event.type](
                            event
                        );
                    }
                    ...
                    function patch(
                        ...
                        if (node === oldNode) {
                            ...
                            oldNode == null ||
                            oldNode.nodeName !== node.nodeName
                        ) {
            ...
            function(require, module, exports) {
                ...
                var options = [
                    ...
                    },
                    {
                        ...
                        key: 'useTabs',
                        description:
                            'Indent lines with tabs? (vs spaces)',
                        type: 'buttons',
                        options: [true, false],
                        validate: 'boolean'
                    },
                    {
                        ...
                        key: 'semi',
                        description:
                            'Print semicolons at end of every statement? (vs ASI only)',
                        type: 'buttons',
                        options: [true, false],
                        validate: 'boolean'
                    },
